...
const QuestPreview = () => {
  ...
  return (
    <section className="relative py-20 bg-aptos-black overflow-hidden" id="quest-preview">
      {/* Background elements */}
      <div className="absolute inset-0 z-0">
        ...
        {/* Cyan fog */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-aptos-cyan/5 blur-[100px]"></div>
        <div className="absolute bottom-1/3 right-1/4 w-80 h-80 rounded-full bg-aptos-aqua/5 blur-[100px]"></div>
          ...
          {quests.map((quest, index) => (
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div className="p-3 rounded-lg bg-aptos-cyan/10 text-aptos-cyan group-hover:scale-110 transition-transform duration-300">
                  {quest.icon}
                </div>
              ...
              <h3 className="text-xl font-bold mb-4 text-aptos-white">{quest.title}</h3>
              
              <div className="flex justify-between items-center">
                <span className="font-bold text-aptos-cyan">{quest.reward}</span>
                <div className="w-8 h-8 rounded-full bg-aptos-cyan/10 flex items-center justify-center">
