...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-aptos-black">
      ...
      <div className="container mx-auto px-4 z-10 text-center">
        ...
        >
          <motion.img
            ...
            alt="APTOS ROOM Logo"
            className="w-32 h-32 mx-auto mb-8 filter drop-shadow-[0_0_15px_rgba(0,229,255,0.8)]"
            animate={{ 
              y: [0, -10, 0],
            }}
            transition={{ 
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-aptos-white">
      ...
      {/* Scroll indicator */}
      <motion.div
        className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-aptos-cyan cursor-pointer"
        animate={{ y: [0, 10, 0] }}
